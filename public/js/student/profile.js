function profileData(){
    ...
    httprequest.onreadystatechange=function(){
        if(httprequest.readyState==4 && httprequest.status==200){
           ...
           var studentname=obj[0].full_name.replace(/_+/g, ',');
           studentname = studentname.replace(/-+/g, ' ');
           studentname=studentname.replace(/~+/g, '/');

           var studentaddress=obj[0].address.replace(/_+/g, ',');
           studentaddress = studentaddress.replace(/-+/g, ' ');
           studentaddress=studentaddress.replace(/~+/g, '/');
           ...
           if(obj[0].gender=="m"){
               ...
               row.innerHTML=
           '<div class="row-1"><div class="col-1">Full Name</div><div class="col-2">:</div><div class="col-3">'+studentname+'</div></div>'+
            ...
            '<div class="row-1"><div class="col-1">Address</div><div class="col-2">:</div><div class="col-3">'+studentaddress+'</div></div>'+
