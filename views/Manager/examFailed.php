...
<head>
    ...
    <script src="<?php echo URL?>public/js/manager/examFailed.js"></script>
                ...
                <div class="part-2">
                    <div class="choise">
                        <div class="cl1-bttn">
                            ...
                            <a href="http://localhost/project/Manager/trialPassed/"><button class="trial">Trial passed</button></a>
                            <a href="http://localhost/project/Manager/examFailed/"><button id="fail" class="fail">Exam Failed</button></a>
                        </div>
                        <div class="cl2">
