...
<head>
    ...
    <!-- examPassedjs -->
    <script src="<?php echo URL?>public/js/manager/examPassed.js"></script>
                ...
                <div class="part-2">
                    <div class="choise">
                        <div class="cl1-bttn">
                            ...
                            <a href="http://localhost/project/Manager/examPassed/"><button id="exam" class="exam">Exam passed</button></a>
