...
<head>
    ...
    <script src="<?php echo URL?>public/js/manager/viewRow.js"></script>
    <link rel="stylesheet" href="<?php echo URL?>public/css/Receptionist/viewRow.css">
    <script src="<?php echo URL?>public/js/manager/viewMore.js"></script>
    <link rel="stylesheet" href="<?php echo URL?>public/css/Manager/addConductor&Vehicle&Student/viewMore.css">

    <link rel="stylesheet" href="<?php echo URL?>public/css/Receptionist/editDetails.css">

    <script src="<?php echo URL?>public/js/manager/payments.js"></script>
        ...
        <div class="big-view">
            ...
            <div class="main_view">
                ...
                <div class="part-2">
                    <div class="choise">
                        <div class="cl1-bttn">
                            <a class="link" href="http://localhost/project/Manager/studentList/"><button id="all" class="all">All</button></a>
                            <a class="link" href="http://localhost/project/Manager/examPassed/"><button class="exam">Exam passed</button></a>
                            <a class="link" href="http://localhost/project/Manager/trialPassed/"><button class="trial">Trial passed</button></a>
                            <a class="link" href="http://localhost/project/Manager/examFailed/"><button class="fail">Exam Failed</button></a>
                        </div>
                        <div class="cl2">
    ...
    <div class="main" id="main">
        <div class="box">
            ...
            <div class="allButtons">
                <a href="http://localhost/project/Manager/studentList/"><button class="back">Back</button></a>
