...
<head>
    ...
    <script src="<?php echo URL?>public/js/manager/trialPassed.js"></script>
        ...
        <div class="big-view">
            ...
            <div class="main_view">
                ...
                <div class="part-2">
                    <div class="choise">
                        <div class="cl1-bttn">
                            <a href="http://localhost/project/Manager/studentList/"><button class="all">All</button></a>
                            <a href="http://localhost/project/Manager/examPassed/"><button class="exam">Exam passed</button></a>
                            <a href="http://localhost/project/Manager/trialPassed/"><button id="trial" class="trial">Trial passed</button></a>
                            <a href="http://localhost/project/Manager/examFailed/"><button class="fail">Exam Failed</button></a>
                        </div>
                        <div class="cl2">
