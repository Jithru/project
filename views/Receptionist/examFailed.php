...
<head>
    ...
    <script src="<?php echo URL?>public/js/receptionist/examFailed.js"></script>
        ...
        <div class="big-view">
            ...
            <div class="main_view">
                ...
                <div class="part-2">
                    <div class="choise">
                        <div class="cl1-bttn">
                            <a href="http://localhost/project/Receptionist/studentList/"><button class="all">All</button></a>
                            <a href="http://localhost/project/Receptionist/examPassed/"><button class="exam">Exam passed</button></a>
                            <a href="http://localhost/project/Receptionist/trialPassed/"><button class="trial">Trial passed</button></a>
                            <a href="http://localhost/project/Receptionist/examFailed/"><button id="fail" class="fail">Exam Failed</button></a>
                        </div>
                        <div class="cl2">
