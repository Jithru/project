...
<ul class="background">
   ...
   <li></li>
        ...
        <div class="view">
                <div class="left">
                    ...
                    <div class="edit-profile">
                           <a href="<?php echo URL?>Receptionist/editprofile"><button class="edit-button">Edit profile</button></a>
    ...
    <script src="<?php echo URL?>public/js/receptionist/profile.js"></script>
</body>
</html>