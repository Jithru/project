...
<body>
        ...
        <div class="container-2">
            ...
            <div class="container-profile">
                ...
                <div class="row-button">
                        ...
                        <a href="<?php echo URL?>Instructor"><button class="back-button">Back</button></a>
                </div>   
            </div> 
    ...
    <script>
        ...
        function submitPwd(){
            ...
            if(newPwd.length==0){
             ...
             if(rePwd.length==0){
                ...
                let url="http://localhost/project/Instructor/validate/"+ crntpwd;
        ...
        function updatePwd(newPwd){
            ...
            let url = "http://localhost/project/Instructor/updatePasswordLogic/" + newPwd;
            httpreq.open("POST",url,true);
            httpreq.send();

        }
    </script>
    <script src="<?php echo URL?>public/js/instructor/editProfilePic.js"></script>
</body>
</html>