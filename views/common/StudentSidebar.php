...
<div class="sidebar" id="sidebar">
    ...
    <div class="nav-list">
        ...
        <a class="list-item" href="<?php echo URL?>Student/questionsAndAnswers" class="<?php echo (getLink()=="http://localhost/project/Student/upload")?"list-item-active":"list-item";?>">
            <span class="link-icon">&#xf0c0</span>
